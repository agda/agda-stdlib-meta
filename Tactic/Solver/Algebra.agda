...
-- carriers are therefore unsupported (they fail loudly, not
-- unsoundly: the operands come out wrong and the backend `refl`
-- won't typecheck).
...
private
  fuel : ℕ
  fuel = 1024 -- Should be sufficient for anything practicl
